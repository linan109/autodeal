...
init_deals = [
    ...
    ["eos-usdt-small", "eos", "usdt", 0.04, 0.80, 12, "60min", 12, 1, 24*60],
    ...
    ["eth-usdt-small-short", "eth", "usdt", 0.04, 0.60, 12, "60min", 4, 1, 6*60],
    ...
    ["eth-usdt-tiny-short", "eth", "usdt", 0.02, 0.60, 12, "60min", 3, 1, 6*60],
