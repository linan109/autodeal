...
init_deals = [
    ["eth-usdt-1", "eth", "usdt", 0.1, 0.90, 8, "60min", 10, 1, 3*24*60],
    ["eos-usdt-1", "eos", "usdt", 0.1, 0.90, 8, "60min", 2, 1, 3*24*60],
    ["iost-usdt-1", "iost", "usdt", 0.1, 0.90, 8, "60min", 1, 1, 3*24*60],
    ["dta-usdt-1", "dta", "usdt", 0.1, 0.90, 8, "60min", 1, 1, 3*24*60],

    ["eth-usdt-small", "eth", "usdt", 0.04, 0.80, 12, "60min", 25, 2, 24*60],
    ["eos-usdt-small", "eos", "usdt", 0.04, 0.80, 12, "60min", 5, 2, 24*60],
    ["iost-usdt-small", "iost", "usdt", 0.04, 0.80, 12, "60min", 1, 1, 24*60],
    ["dta-usdt-small", "dta", "usdt", 0.04, 0.80, 12, "60min", 1, 1, 24*60],
    ["bch-usdt-small", "bch", "usdt", 0.04, 0.80, 12, "60min", 2, 2, 24*60],
    ["etc-usdt-small", "etc", "usdt", 0.04, 0.80, 12, "60min", 4, 1, 24*60],
    ["ht-usdt-small", "ht", "usdt", 0.04, 0.80, 12, "60min", 2, 1, 24*60],

    ["eth-usdt-small-short", "eth", "usdt", 0.04, 0.60, 12, "60min", 6, 1, 6*60],
    ["eos-usdt-small-short", "eos", "usdt", 0.04, 0.60, 12, "60min", 1, 1, 6*60],
    ...
    ["ht-usdt-small-short", "ht", "usdt", 0.04, 0.60, 12, "60min", 1, 1, 6*60],

    ["eth-usdt-fast", "eth", "usdt", 0.06, 0.70, 4, "60min", 5, 1, 3*24*60],
    ["eos-usdt-fast", "eos", "usdt", 0.06, 0.70, 4, "60min", 1, 1, 3*24*60],
    ["iost-usdt-fast", "iost", "usdt", 0.06, 0.70, 4, "60min", 1, 1, 3*24*60],
    ["dta-usdt-fast", "dta", "usdt", 0.06, 0.70, 4, "60min", 1, 1, 3*24*60],

    ["eth-usdt-tiny-short", "eth", "usdt", 0.02, 0.60, 12, "60min", 10, 1, 6*60],
    ...
    ["ht-usdt-tiny-short", "ht", "usdt", 0.02, 0.60, 12, "60min", 1, 1, 6*60],
