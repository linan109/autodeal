...
init_deals = [
    ...
    ["eos-usdt-1", "eos", "usdt", 0.1, 0.90, 8, "60min", 10, 1, 3*24*60],
    ...
    ["eos-usdt-small", "eos", "usdt", 0.04, 0.80, 12, "60min", 18, 2, 24*60],
    ...
    ["eos-usdt-small-short", "eos", "usdt", 0.04, 0.60, 12, "60min", 4, 1, 6*60],
    ...
    ["eos-usdt-fast", "eos", "usdt", 0.06, 0.70, 4, "60min", 5, 1, 3*24*60],
    ...
    ["eos-usdt-tiny-short", "eos", "usdt", 0.02, 0.60, 12, "60min", 8, 1, 6*60],
